...
environment = Environment.create(
    environment= Env_base(train_data, env_name = env_name, mode='verbose', mae=1.5, thresh=thresh, reward_type=exp_name), max_episode_timesteps=80000)
from tensorforce.agents import Agent
from tensorforce.execution import Runner
agent = Agent.create(
    agent='dqn', environment=environment, batch_size=10, memory=99999,learning_rate=1e-3
)
...
rows = []
log_path = "tensorforce_logs/dqn.csv"
...
agent.save("RL_checkpoints/helpdeskDQN")
