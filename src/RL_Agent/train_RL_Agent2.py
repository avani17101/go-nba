...
from RL_Agent.Maskable_PPO_parallel import *
import numpy as np


np.set_printoptions(linewidth=1000)

def train_RL(env, episodes, checkpoint_dir, log_dir,env_name,exp_name):
    ####### initialize environment hyperparameters ######
    has_continuous_action_space = False
    max_ep_len = 8000000                  # max timesteps in one episode
    ...
    while i_episode <= max_episodes:    
        ...
        env.render()
        rows.append([i_episode, avg_reward, env.accuracy_final, env.mae_final, env.percent_overall_gs, env.percent_overall_gv, env.percent_gv_which_became_gs,env.percent_gs_which_became_gv])
        ...
        if avg_reward > prev_avg_reward: #best model
            print("--------------------------------------------------------------------------------------------")
    ...
    print("============================================================================================")
    print("============================================================================================")
    return checkpoint_path2, log_path
